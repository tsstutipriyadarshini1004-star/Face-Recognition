...
classifier = cv2.CascadeClassifier(r"C:\Users\DELL\Desktop\Face_Project\haarcascade_frontalface_default (1).xml")

model = load_model(r"C:\Users\DELL\Desktop\Face_Project\fac.h5")
